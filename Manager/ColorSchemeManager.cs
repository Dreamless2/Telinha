...
namespace Telinha.Manager
{
    ...
    public static class ColorSchemeManager
    {
        ...
        public static ColorScheme GenerateFromBase(Color baseColor, bool darkMode = false)
        {
            ...
            var primary = FromHsl(hsl.H, 0.7, darkMode ? 0.4 : 0.6);
            var secondary = FromHsl((hsl.H + 30) % 360, 0.4, darkMode ? 0.3 : 0.7);
            var tertiary = FromHsl((hsl.H + 60) % 360, 0.5, darkMode ? 0.35 : 0.65);
